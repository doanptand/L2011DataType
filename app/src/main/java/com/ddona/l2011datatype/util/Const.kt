package com.ddona.l2011datatype.util
...
object Const {
    ...
    const val QUERY_CREATE_STUDENT_TABLE =
        "CREATE TABLE $TABLE_STUDENT($COL_ID INTEGER PRIMARY KEY AUTOINCREMENT, $COL_NAME TEXT, $COL_AGE INTEGER, $COL_CLASS_NAME TEXT)"
}